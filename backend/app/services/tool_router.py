...
- IMPORTANT When the user asks about INSPECTION SUMMARY, return anomaly data for that inspection. WHEN THE USER ASKS TO COMPARE inspections, ALWAYS return anomaly data (summary, locations, and details) for ALL inspections (UNLESS THE USER MENTIONS SPECIFIC ONES), not just the reference inspection. The user wants to know what was found in each inspection, not just the reference.
